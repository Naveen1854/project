...
public class TicketController {
	...
	public ResponseEntity<ResponseStructure<Ticket>> updateTicketById(@RequestParam int oldTicketId,
	...
	public ResponseEntity<ResponseStructure<Ticket>> addExistingPaymentToExistingTicket(@RequestParam int paymentId,
