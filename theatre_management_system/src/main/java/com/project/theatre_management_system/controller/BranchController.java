...
public class BranchController {
	...
	public ResponseEntity<ResponseStructure<Branch>> addExistingStaffToExistingBranch(@RequestParam int staffId,
			@RequestParam int branchId) {
	...
	public ResponseEntity<ResponseStructure<Branch>> addNewStaffToExistingBranch(@RequestParam int branchId,
	...
	public ResponseEntity<ResponseStructure<Branch>> addExistingScreenToExistingBranch(@RequestParam int screenId,
			@RequestParam int branchId) {
	...
	public ResponseEntity<ResponseStructure<Branch>> addNewScreenToExistingBranch(@RequestParam int branchId,
